...
<!-- 네비바 -->
   ...
   <form id="addCustomerForm" method ="post" action ="${pageContext.request.contextPath}/login/addCustomer" enctype="multipart/form-data">
      <table>
         <tr>
            <th>프로필 사진</th>
            <td>
         ...
         <tr>
            <th>아이디</th>
            <td>
               <input type ="text" id = "customerId" name="customerId" readonly="readonly">
            </td>
         </tr>
         <tr>   
            <th>이름</th>
