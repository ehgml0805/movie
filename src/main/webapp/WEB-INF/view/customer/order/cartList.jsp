...
<div>
	...
	<div class="container">
		...
		<c:forEach var="c" items="${list}">
			<table width="100%">
				...
				<tr>
					...
					<td width="15%"><img src="${pageContext.request.contextPath}/snackImg/${c.fileName}.${c.fileType}" width= "200px" height="200px"></td>
					<td>
		...
		<fieldset style="text-align: center;">
			...
			<br><br>
		<div style="text-align: center;"><button type="button" class="btn btn-outline-dark btn-lg" onclick="location.href='${pageContext.request.contextPath}/customer/order/paymentCart'">결제하기</button></div>
		</c:if>
		<br><br><br><br>
			<div>
