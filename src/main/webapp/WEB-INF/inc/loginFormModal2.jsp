		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="form-login">
					...
					<input type="text" class="form-control mt-3" name="customerPw" id="customerPw" placeholder="비밀번호" maxlength="12" />
				</form>
				...
				<div class="container-a mt-3">
					...
					<a class="link-secondary" href="${pageContext.request.contextPath}/login/addCustomer">회원가입</a>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	$(function() {
		const idInput = $("[name='customerId']");
		const passwordInput = $("[name='customerPw']");
		...
		loginButton.click(function(event) {
			...
			$.ajax({
				type: "POST",
				url: "${pageContext.request.contextPath}/login/loginCustomer",
